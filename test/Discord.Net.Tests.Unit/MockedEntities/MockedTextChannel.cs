...
namespace Discord
{
    internal sealed class MockedTextChannel : ITextChannel
    {
        ...
        public Task<IReadOnlyCollection<IThreadChannel>> GetPublicArchivedThreadsAsync(DateTimeOffset? before = null, int? limit = null, RequestOptions options = null) => throw new NotImplementedException();
    }
}
